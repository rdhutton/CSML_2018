...
for page_id in [247]:
    ...
    # test text
    # text = "I met a traveller from an antique land who said two vast and trunkless legs of stone stand in the desert. Near them on the sand a sunken visage lies"
    ...
    # quotes_list = ["vast and trunkless legs of stone"]
    ...
    match_locs = []
    # word_strings = ["two","vast","desert", "and","stone", "I","lies","trunkless","legs","legs","OOV","met","of"]
    # word_strings = ["two","vast","desert", "and","stone", "near","lies","trunkless","legs","legs","OOV","met","of", "sunken"]
    # word_strings = ["two","trunkless","legs","of", "sunken"]
    for word in word_strings:
        ...
        for match in p.finditer(wrapped_text.lower()):
            ...
            # print("match_start,end = ",match.start(),match.end())

    # select this line only - to highlight LIME words only
    # wrapped_text = colour_regions(wrapped_text, match_locs, BLUE_BACKGROUND)
    # wrapped_text = overlay_colour_regions3(wrapped_text,match_locs,quote_regions,BLUE_BACKGROUND,RED_FOREGROUND,RED_BLUE)
